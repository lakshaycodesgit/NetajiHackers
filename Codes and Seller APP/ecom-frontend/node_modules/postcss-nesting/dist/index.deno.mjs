...
function sortCompoundSelectorsInsideComplexSelector(node) {
  ...
  for (let i = 0; i < node.nodes.length; i++) {
    if (node.nodes[i].type === 'combinator') {
      ...
      compoundSelectors.push(currentCompoundSelector); // Push the combinator

      compoundSelectors.push([node.nodes[i]]); // Start a new compound selector
    ...
    if (parser.isPseudoElement(node.nodes[i])) {
      // Push the current compound selector
      compoundSelectors.push(currentCompoundSelector); // Start a new compound selector with the pseudo element as the first element
...
function s(n) {
  ...
  let t = 0,
      c = 0,
      o = 0;
  if ("universal" == n.type) return {
    a: 0,
    b: 0,
    c: 0
  };
  if ("id" === n.type) t += 1;else if ("tag" === n.type) o += 1;else if ("class" === n.type) c += 1;else if ("attribute" === n.type) c += 1;else if (function (s) {
    return parser.isPseudoElement(s);
  }(n)) o += 1;else if (parser.isPseudoClass(n)) switch (n.value) {
    case ":-moz-any":
    case ":-webkit-any":
    case ":any":
    case ":has":
    ...
    case ":nth-child":
    case ":nth-last-child":
      if (c += 1, n.nodes && n.nodes.length > 0) {
        const s = n.nodes[0].nodes.findIndex(e => "tag" === e.type && "of" === e.value);

        if (s > -1) {
          const l = [parser.selector({
            nodes: n.nodes[0].nodes.slice(s + 1),
            value: ""
          })];
          n.nodes.length > 1 && l.push(...n.nodes.slice(1));
          const i = a(l);
          t += i.a, c += i.b, o += i.c;
        }
      }
    ...
    case ":local":
    case ":global":
      n.nodes && n.nodes.length > 0 && n.nodes.forEach(e => {
        const a = s(e);
        t += a.a, c += a.b, o += a.c;
      });
      break;
    ...
    default:
      c += 1;
  } else parser.isContainer(n) && n.nodes.length > 0 && n.nodes.forEach(e => {
    const a = s(e);
    t += a.a, c += a.b, o += a.c;
  });
  return {
...
function a(e) {
  ...
  return e.forEach(e => {
    const n = s(e);
    n.a > a.a ? a = n : n.a < a.a || (n.b > a.b ? a = n : n.b < a.b || n.c > a.c && (a = n));
  }), a;
}
